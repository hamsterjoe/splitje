import { z } from "zod";
import { AdjustmentCalculationBaseMode, BillAdjustmentType, RateRoundingMode } from "@/domain/billing/types";
...
export type OwnerBillAdjustmentCalculationMethod =
    | "fixed"
    | "rate";

export type OwnerBillAdjustmentAmountSource =
    | "manual"
    | "calculated"
    | "printed"
    | "manual_override";
...
export interface OwnerBillAdjustment {
    ...
    roundingMode: RateRoundingMode | null;
    calculationBaseMode:
    AdjustmentCalculationBaseMode | null;
    amountSource:
